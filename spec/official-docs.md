# Official Docs (from app.ainm.no)

> Saved 2026-03-01. Authoritative — overrides MCP server docs where they conflict.

---

## Getting Started

Sign in at app.ainm.no with Google, create/join a team, go to Challenge page, pick
a difficulty, click Play. Connect bot via WebSocket.

- **Endpoint**: `wss://game.ainm.no/ws?token=<jwt_token>`
- **Token**: Click "Play" on a map at app.ainm.no/challenge
- **Requirements**: Python 3.10+, `websockets`, respond within 2s per round
- **Rate limits**: 60s cooldown between games, max 40/hr, 300/day per team
...
- **Easy** — Solo Pathfinding: One bot, small store. Focus on efficient routing.
- **Medium** — Team Coordination: Three bots, larger store. Divide the work.
- **Hard** — Multi-Agent Planning: Five bots, complex layout. Avoid duplicate work.
- **Expert** — Swarm Management: Ten bots, massive store. Coordinate a swarm efficiently.
