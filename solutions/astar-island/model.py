...
PLAINS_REMOTE_PRIOR = [0.80, 0.05, 0.03, 0.05, 0.05, 0.02]
PLAINS_NEAR_SETTLEMENT_PRIOR = [0.50, 0.25, 0.10, 0.10, 0.03, 0.02]
SETTLEMENT_PRIOR = [0.05, 0.60, 0.15, 0.15, 0.03, 0.02]
PORT_PRIOR = [0.05, 0.15, 0.60, 0.15, 0.03, 0.02]
